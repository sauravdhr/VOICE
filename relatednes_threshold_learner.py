...
def main(full_network_filename, outbreaks_networks_dir):
    full_network_edges = graph_utils.import_graph_from_json(full_network_filename).edges()
    outbreaks_networks = [graph_utils.import_graph_from_json(f) for f in os.listdir(outbreaks_networks_dir)]
